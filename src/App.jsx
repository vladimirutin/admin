...
function SupportView({ tickets, db, appId, isDarkMode, onHide }) {
    ...
    const displayTickets = tickets.length > 0 ? tickets : [
        { id: 'mock1', subject: 'Kiosk K-101 Door Opened', message: 'Sensor detected unauthorized door access.', sender: 'System Alert', status: 'open', priority: 'high', type: 'kiosk_alert', timestamp: { seconds: Date.now()/1000 } },
